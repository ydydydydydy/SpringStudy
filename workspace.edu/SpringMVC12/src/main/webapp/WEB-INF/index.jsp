                  ...
                  <!-- 스와이퍼슬라이드 시작 -->    
                   <div class="swiper mySwiper">
                     <div class="swiper-wrapper">
                       <div class="swiper-slide"><div>1</div><div><img src="resources/img/team-1.png"></div></div>
                       <div class="swiper-slide"><div>3</div><div><img src="resources/img/team-2.png"></div></div>
            ...
            <div class="row g-4">
               <div class="col-lg-4" data-wow-delay="0.1s">
                  <div class="feature-item bg-light rounded text-center p-4">
                     ...
                     <p class="m-0">최고의 협업을 경험해보세요! 우리의 플랫폼은 기업 간 협력의 이점을 파악하여 효과적이고, 성공적으로 만들어드립니다! </p>
                  </div>
               </div>
               <div class="col-lg-4 " data-wow-delay="0.3s">
                  <div class="feature-item bg-light rounded text-center p-4">
                     ...
                     <p class="m-0">원하는 결과를 검색해보세요. 기업의 이익을 상승시키는 예를 찾아 질문에 맞춰 검색결과를 알려드립니다!</p>
                  </div>
               </div>
               <div class="col-lg-4 " data-wow-delay="0.5s">
                  <div class="feature-item bg-light rounded text-center p-4">
                     ...
                     <p class="m-0">여러분의 기업과도 협업을 원하는 기업을 찾아보세요! 다양한 기업 프로필을 살펴보고 여러분의 목표에 부합하는 파트너 기업을 선택해서 성공을 위한 첫걸음을 내딛어보세요.</p>
                  </div>
               </div>
            </div>
         </div>
