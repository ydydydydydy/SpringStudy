					...
					<table style="text-align: center;" class="table table-bordered">
							...
							<td colspan="2">
								<div class="form-group"
									...
									<div class="btn-group" data-toggle="buttons">
										...
										<label class="btn btn-primary"> <input type="radio" id="memGender" name="memGender" autocomplete="off" value="여자"> 여자
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td colspan="2"><input type="email" name="memEmail"
								id="memEmail" class="form-control" maxlength="20"
						...
						<tr>
							...
							<input type="reset" class="btn btn-warning btn-sm pull-right" value="취소"></td>
						</tr>
