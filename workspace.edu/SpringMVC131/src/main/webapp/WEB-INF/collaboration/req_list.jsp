...
<body>
  ...
  <%@include file="/WEB-INF/header.jsp"%>
                           ...
                           <div class="container_card">
                             ...
                             <div class="back_card">
                               <div class="inner_card">
                                 ...
                                 <p id="truncatedContent">${vo.req_content}</p>
                               </div>
                             </div>
                           </div>
                         </div>
    ...
    <script>
    	// JavaScript를 사용하여 앞에서부터 30글자만 보이도록 설정
    	const originalContent = "${vo.req_content}";
    	const truncatedContent = originalContent.length > 30 ? originalContent.substring(0, 30) + "..." : originalContent;
