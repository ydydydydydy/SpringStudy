...
<body>
   ...
   <div class="container" id="container">
     <div class="form-container sign-up-container">
         ...
         <button type="button" onclick="businessCheck()">진위여부</button>
         <div class="valid-feedback"></div>
         <div class="invalid-feedback"></div>
 ...
 <div class="modal" id="myModal">
   ...
   <script type="text/javascript">
      ...
      function registerCheck(){
          ...
          $.ajax({
             ...
             success : function(data){
                ...
                if(data){
                   showMessage("이미 사용중인 이메일 입니다.");
                }else{
                   showMessage("사용할 수 있는 이메일 입니다.");
                   isEmailChecked = true;
                }
             },
    ...
    function clickEvent(){
       if (isEmailChecked && isBusinessValid && isPasswordChecked){
           document.getElementById('joinForm').submit(); // yourFormId에는 form 태그의 id를 넣어주세요
       }else if (!isEmailChecked) {
            showMessage("이메일 중복확인을 해주세요."); // 모달에 이메일 확인 메세지 표시
